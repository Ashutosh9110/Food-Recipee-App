...
const useFluidCursor = () => {
  ...
  function generateColor() {
    // Use themed colors - pinks, purples, and blues
    const themeColors = [
      { r: 1.0, g: 0.2, b: 0.5 },  // Pink
      { r: 0.8, g: 0.2, b: 1.0 },  // Purple
      { r: 0.3, g: 0.2, b: 1.0 },  // Blue
      { r: 0.5, g: 0.2, b: 0.8 }   // Lavender
    ];
    
    // Select a random color from the theme colors
    const randomIndex = Math.floor(Math.random() * themeColors.length);
    let c = themeColors[randomIndex];
